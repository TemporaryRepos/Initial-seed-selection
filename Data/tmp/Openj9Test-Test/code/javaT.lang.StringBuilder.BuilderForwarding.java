public class BuilderForwarding {
	...
	public BuilderForwarding() {
		java.lang.System.out.println("Starting BuilderForwarding");
	}

	public static void main(java.lang.String... args) {
		new javaT.lang.StringBuilder.BuilderForwarding().executeTestMethods();
	}
	...
	public void appendCharSequence() {
		java.lang.CharSequence aString = javaT.lang.StringBuilder.BuilderForwarding.A_STRING_VAL;
		java.lang.CharSequence aStringBuilder = new java.lang.StringBuilder(javaT.lang.StringBuilder.BuilderForwarding.A_STRING_BUILDER_VAL);
		java.lang.CharSequence aStringBuffer = new java.lang.StringBuffer(javaT.lang.StringBuilder.BuilderForwarding.A_STRING_BUFFER_VAL);
		assertEquals(new java.lang.StringBuilder().append(aString).toString(), javaT.lang.StringBuilder.BuilderForwarding.A_STRING_VAL);
		assertEquals(new java.lang.StringBuilder().append(aStringBuilder).toString(), javaT.lang.StringBuilder.BuilderForwarding.A_STRING_BUILDER_VAL);
		assertEquals(new java.lang.StringBuilder().append(aStringBuffer).toString(), javaT.lang.StringBuilder.BuilderForwarding.A_STRING_BUFFER_VAL);
		assertEquals(new java.lang.StringBuilder(javaT.lang.StringBuilder.BuilderForwarding.NON_EMPTY_VAL).append(aString).toString(), javaT.lang.StringBuilder.BuilderForwarding.NON_EMPTY_VAL + javaT.lang.StringBuilder.BuilderForwarding.A_STRING_VAL);
		assertEquals(new java.lang.StringBuilder(javaT.lang.StringBuilder.BuilderForwarding.NON_EMPTY_VAL).append(aStringBuilder).toString(), javaT.lang.StringBuilder.BuilderForwarding.NON_EMPTY_VAL + javaT.lang.StringBuilder.BuilderForwarding.A_STRING_BUILDER_VAL);
		assertEquals(new java.lang.StringBuilder(javaT.lang.StringBuilder.BuilderForwarding.NON_EMPTY_VAL).append(aStringBuffer).toString(), javaT.lang.StringBuilder.BuilderForwarding.NON_EMPTY_VAL + javaT.lang.StringBuilder.BuilderForwarding.A_STRING_BUFFER_VAL);
	}
	...
	public void indexOfString() {
		...
		sb = new java.lang.StringBuilder("xyz");
	...
	public void indexOfStringint() {
		...
		sb = new java.lang.StringBuilder("xyyz");
	...
	public void insertintboolean() {
		boolean b = true;
		java.lang.StringBuilder sb = new java.lang.StringBuilder("012345");
	...
	public void insertintCharSequence() {
		...
		java.lang.CharSequence aStringBuilder = new java.lang.StringBuilder(javaT.lang.StringBuilder.BuilderForwarding.A_STRING_BUILDER_VAL);
		java.lang.CharSequence aStringBuffer = new java.lang.StringBuffer(javaT.lang.StringBuilder.BuilderForwarding.A_STRING_BUFFER_VAL);
		assertEquals(new java.lang.StringBuilder(initString).insert(2, aString).toString(), ("01" + javaT.lang.StringBuilder.BuilderForwarding.A_STRING_VAL) + "2345");
		assertEquals(new java.lang.StringBuilder(initString).insert(2, aStringBuilder).toString(), ("01" + javaT.lang.StringBuilder.BuilderForwarding.A_STRING_BUILDER_VAL) + "2345");
		assertEquals(new java.lang.StringBuilder(initString).insert(2, aStringBuffer).toString(), ("01" + javaT.lang.StringBuilder.BuilderForwarding.A_STRING_BUFFER_VAL) + "2345");
		try {
			new java.lang.StringBuilder(initString).insert(7, aString);
	...
	public void lastIndexOfString() {
		...
		java.lang.StringBuilder sb = new java.lang.StringBuilder(xyz3);
		int pos = sb.lastIndexOf("xyz");
		assertEquals(pos, 2 * xyz.length());
	}

	public void lastIndexOfStringint() {
		java.lang.StringBuilder sb = new java.lang.StringBuilder("xyzxyzxyz");
