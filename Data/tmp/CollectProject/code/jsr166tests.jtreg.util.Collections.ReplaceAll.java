public class ReplaceAll {
	...
	public static void main(java.lang.String[] args) throws java.lang.Exception {
		...
		for (int i = 0; i < a.length; i++) {
			...
			for (int j = 1; j <= jsr166tests.jtreg.util.Collections.ReplaceAll.SIZE; j++) {
				lst.add(new java.lang.Integer(j % 3));
			}
			java.util.List goal = java.util.Collections.nCopies(jsr166tests.jtreg.util.Collections.ReplaceAll.SIZE, "*");
			for (int j = 0; j < 3; j++) {
